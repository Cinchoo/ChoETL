...
{
    public class DeserializeToConcreteClassesUsingDiscriminatorAndKnownTypesTests
    {
...
[
  {
    ...
    [
      ...
      },
      {
        ...
        //}
        [Test]
        public static void DeserializeToConcreteClassesUsingDiscriminatorAndKnownTypesTest()
        {
