...
namespace ChoETL
{
    internal class ChoParquetRecordWriter : ChoRecordWriter
    {
        ...
        public ChoParquetRecordWriter(Type recordType, ChoAvroRecordConfiguration configuration) : base(recordType)
        {
        ...
        private void WriteAllRecords(StreamWriter sw)
        {
            ...
            using (var parquetWriter = new ParquetWriter(schema, sw.BaseStream, Configuration.AvroSerializerSettings, Configuration.Append))
            {
        ...
        public object GetPropertyValue(object target, PropertyInfo propertyInfo, ChoAvroRecordFieldConfiguration fieldConfig)
        {
   ...
   //             }
        ...
        private string NormalizeFieldValue(string fieldName, string fieldValue, int? size, bool truncate, bool? quoteField,
            ...
            ChoFieldValueTrimOption? fieldValueTrimOption = null, ChoAvroRecordFieldConfiguration fieldConfig = null,
